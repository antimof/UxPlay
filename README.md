...
currently only partially supported by UxPlay: reports indicate that
screen-mirroring video works, but a so-far not-understood protocol difference means the audio stream is not correctly decrypted.
